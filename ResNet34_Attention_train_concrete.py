...
train_images_path, train_images_label, val_images_path, val_images_label = read_split_data('Concrete Crack Images for Classification')
# 实例化训练数据集
...
if __name__ == '__main__':
    ...
    filename = 'resnet34_Concrete_attention.txt'
